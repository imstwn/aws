			...
			<div class="card shadow bg-body rounded p-5">
				...
				<div class="my-3">
					<div class="row g-2">
						<div class="col-6">
							<div class="d-grid">
                        		<input class="btn btn-outline-primary btn-lg" name="submit" type="submit" id="log_login" value="Login">
                    		</div>
						</div>
						<div class="col-6">
							<div class="d-grid">
	...
	<script>
		$(document).ready(function(){
			...
			$('#reg').click(function(){
				...
				if (username == '' || email == '') {
					alert('Harap Isikan Username dan/atau Email')
				} else {
					$.ajax({
				    	...
				    	success: function(data){
				    		...
				    		} else if (data == 'emailFormat') {
				    			alert('Wrong Email Format');
				    		} else if (data == 'goReg') {
				    			alert('Silahkan Cek Email dan Melakukan Login');
				    			window.location.href = 'login.php';
				    		}
				    	},
